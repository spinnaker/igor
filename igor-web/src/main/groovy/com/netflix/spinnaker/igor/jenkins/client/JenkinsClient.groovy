...
interface JenkinsClient {
    ...
    Build getBuild(@EncodedPath('jobName') String jobName, @Path('buildNumber') String buildNumber)
    ...
    ScmDetails getGitDetails(@EncodedPath('jobName') String jobName, @Path('buildNumber') String buildNumber)
    ...
    Response submitDescription(@EncodedPath('jobName') String jobName, @Path('buildNumber') String buildNumber, @Field("description") String description, @Header("Jenkins-Crumb") String crumb)

    @POST('/job/{jobName}/{buildNumber}/stop')
    Response stopRunningBuild(@EncodedPath('jobName') String jobName, @Path('buildNumber') String buildNumber,  @Body String EmptyRequest, @Header("Jenkins-Crumb") String crumb)
    ...
    Response getPropertyFile(
        ...
        @Path('buildNumber') String buildNumber, @Path(value = 'fileName', encode = false) String fileName)
